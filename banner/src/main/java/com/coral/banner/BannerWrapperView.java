...
import com.coral.banner.utils.DimenUtil;
...
public class BannerWrapperView<T> extends FrameLayout {
    ...
    public void initView() {
        ...
        mIndicatorContainer = (LinearLayout) findViewById(R.id.indicatorView);
    ...
    private void startPlay() {
        if (mViewPager != null && mHandler != null && !isPlaying && mPlayImageAuto) {
            mHandler.sendEmptyMessageDelayed(0, DELAY_TIME);
            isPlaying = true;
        }
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        setMeasuredDimension(getMeasuredWidth(), (int) newHeight);
    }
